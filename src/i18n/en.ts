...
export const en = {
  ...
  analystPage: {
    ...
    example1: 'What did {horse} do yesterday?',
    example2: "How is {horse}'s fitness developing?",
    example3: 'Which horses trained hardest this week?',
    exampleHorseFallback: 'your horse',
    inputPlaceholder: 'Ask about a horse or session…',
    send: 'Send',
    sendAria: 'Send question',
    thinking: 'Thinking…',
    error: "Couldn't reach the analyst. Try again.",
    conversationAria: 'Analyst conversation',
    youLabel: 'You',
    analystLabel: 'Analyst',
    disclaimer: "AI, grounded in your stable's measured data. Not veterinary or prescriptive advice.",
  },
  roles: {
    trainer: 'Trainer',
    owner: 'Owner',
